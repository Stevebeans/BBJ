...
const FeedUpdatesPage = () => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    const fetchData = async () => {
      const result = await axios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/wp-json/bbj/v1/feed-updates", {
        params: {
          mode: "getInitial"
        }
      });
    ...
    const checkLatest = async () => {
      ...
      if (lastPostID !== lastViewedID) {
        const countResult = await axios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/wp-json/bbj/v1/feed-updates", {
          params: {
            mode: "getCount",
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mt-6"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_PostList__WEBPACK_IMPORTED_MODULE_2__["default"], {
    posts: posts,
