...
class FeedEdit {
  ...
  saveChanges(id) {
    ...
    console.log(`Saving changes for ID ${id}. Title: ${titleValue}, Content: ${contentValue}`); // Construct formData for the AJAX request
    ...
    fetch(playerData.root_url + "/wp-json/wp/v2/live-feed-updates/" + id, {
      ...
      document.getElementById("content-" + id).innerHTML = data.content.rendered; // Hide editable fields
...
/* harmony default export */ __webpack_exports__["default"] = (FeedEdit);
...
class PaymentModel {
  ...
  chooseItem(e) {
    this.summaryElement.classList.remove("hidden"); // Remove any existing 'selected' class
    ...
    selectedItem.classList.add("selected"); // Get the plan type and value of the clicked item

    const planType = selectedItem.getAttribute("data-plan-type");
    const planValue = selectedItem.getAttribute("data-value"); // Update the form fields with the selected plan type

    this.paymentForm.querySelector("#field_plan-type").value = planType;
    this.paymentForm.querySelector("#field_stripe-plan-type").value = planType; // Update the payment summary
...
const PlayerTableReact = () => {
  ...
  console.log("React");
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    axios__WEBPACK_IMPORTED_MODULE_7__["default"].get(playerData.root_url + "/wp-json/bbj/v1/player_info/").then(res => {
      setPlayers(res.data);
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ReactComponents_GenderInput__WEBPACK_IMPORTED_MODULE_5__["default"], {
    handleGender: handleGender
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ReactComponents_SelectSeason__WEBPACK_IMPORTED_MODULE_6__["default"], {
    seasons: seasons,
    handleSeason: handleSeason
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "bbj-player-card-wrap"
  }, filteredByGenderPlayers.length > 0 ? filteredByGenderPlayers.map(player => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ReactComponents_PlayerCard__WEBPACK_IMPORTED_MODULE_3__["default"], {
    key: player.id,
    player: player
...
function BBJSearchBar() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    ...
    setIsLoading(true);
    setTimeout(() => {
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].get(`/wp-json/bbj/v1/search?q=${inputValue}`).then(response => {
