        ...
        <div class="widgetBody">
          ...
          <div class="entry-content">
            ...
            <div class="feed-update-container">
                ...
                <?php $stream = '[ajax_load_more id="9371596830" container_type="div" cta="true" cta_position="before:5" cta_theme_repeater="adsense-feed-updates.php" seo="true" theme_repeater="feed-list.php" post_type="live-feed-archives" posts_per_page="10" destroy_after="20"]'; ?> 
